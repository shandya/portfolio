...
export default function Archive() {
  ...
  return (
    <>
      <Head>
        <title>Archive | Shandy Ardiansyah</title>
        <meta name="description" content="Archive page showcasing a diverse range of projects and creative works" />
        <meta property="og:title" content="Archive | Shandy Ardiansyah" />
        <meta property="og:description" content="Archive page showcasing a diverse range of projects and creative works" />
      </Head>
